export enum WalletErrorCode {
  ...
  HARDWARE_WALLET_NOT_FOUND = 'HARDWARE_WALLET_NOT_FOUND',
  HARDWARE_WALLET_CONNECTION_FAILED = 'HARDWARE_WALLET_CONNECTION_FAILED',
  HARDWARE_WALLET_SIGNING_FAILED = 'HARDWARE_WALLET_SIGNING_FAILED',
  HARDWARE_WALLET_DEVICE_LOCKED = 'HARDWARE_WALLET_DEVICE_LOCKED',
